...
public class ApiController {
	...
	// DELETE playdate from database (method on front end uses if statement to check if poster id === current pet id)
	@DeleteMapping("/playdate/delete/{id}")
	public void deletePlaydate(@PathVariable(value = "id") int playdateId) {
